...
const contentSecurityPolicy = [
  ...
  `script-src 'self' 'unsafe-inline' https://www.clarity.ms https://scripts.clarity.ms https://va.vercel-scripts.com ${postHogScriptSources}${isDevelopment ? " 'unsafe-eval'" : ""}`,
